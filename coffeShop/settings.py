...
SECRET_KEY = 'django-insecure-$52nq9kwr!7b7eg8zg70&q4$de5nrd*2kdh$$c(y$thuq(0j&8'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True # si está en true
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'coffeShop' / 'templates'], # Añadir esta línea
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
LOGOUT_REDIRECT_URL = 'products'         # Carpeta donde se guardarán los archivos multimedia